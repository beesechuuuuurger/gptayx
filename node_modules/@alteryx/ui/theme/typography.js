...
var getDeprecatedOverrides = function getDeprecatedOverrides(palette, baseVariants) {
  var variantSize = {
    regular: {
      fontSize: pxToRem(13),
      fontWeight: 'normal',
...
var _default = function _default(palette) {
  ...
  return (0, _extends2.default)({}, baseOverrides, getDeprecatedOverrides(palette, baseOverrides));
};
