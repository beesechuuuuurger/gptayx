...
var getUICorePalette = function getUICorePalette(_) {
  ...
  var primaryMainDark = '#3f95ff';
  var selectedBase = darkMode ? primaryMainDark : primaryMain;
  var textSecondaryBase = darkMode ? '#d6dff2' : '#0a204a';
  var hoverBase = BlueGreys.light[500];

  var getFocusedShadowStyle = function getFocusedShadowStyle() {
  ...
  return {
    ...
    action: {
      ...
      disabledBackground: darkMode ? (0, _styles.fade)(blueGrey[400], 0.04) : (0, _styles.fade)(blueGrey[300], 0.2),
    ...
    getFocusedShadowStyle: getFocusedShadowStyle,
    getFocusedStyle: function getFocusedStyle() {
      return {
