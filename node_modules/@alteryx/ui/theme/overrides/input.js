...
var MInput = function MInput(theme) {
  return {
    root: {
      ...
      '&$focused, &$focused:hover': (0, _extends2.default)({}, theme.palette.getFocusedStyle()),
      '&:hover': {
...
var MFilledInput = function MFilledInput(theme) {
  return {
    root: {
      ...
      backgroundColor: theme.palette.type === 'dark' ? (0, _styles.fade)(theme.palette.blueGrey['300'], 0.08) : (0, _styles.fade)(theme.palette.blueGrey['300'], 0.25),
      '&:hover': {
      ...
      '&$focused': (0, _extends2.default)({}, theme.palette.getFocusedStyle(), {
...
var MSelect = function MSelect(_ref2) {
