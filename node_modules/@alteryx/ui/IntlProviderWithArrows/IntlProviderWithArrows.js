...
var IntlProviderWithArrows = function IntlProviderWithArrows(_ref) {
  ...
  var provideStars = locale === 'stars';
  var testingLocale = provideArrows || provideStars;
  var newLocale = testingLocale ? 'en' : locale;
  var newMessages = testingLocale ? (0, _utils.padMessages)(messages, padMessagesProps, provideStars) : messages;
